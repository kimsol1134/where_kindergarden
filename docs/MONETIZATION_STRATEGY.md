# 우리동네 유치원 앱 - 사용자 확보 & 수익화 전략 (초기안)

> 최초 작성: 2026-01-28 · 데이터 현황 갱신: 2026-08-06
>
> 최신 의사결정은 [2026-08-06 비판적 수익화 검토](reports/kindergarten-retention-monetization-2026-08-06/critical-review/report.html)를 우선합니다. 이 문서의 실행 아이디어는 역사적 초기안입니다.
...
| 웹 | Vercel 운영 중 |
| 최근 30일 활성 | 186명 |
| 유치원 데이터 | 7,152개 (교육부 2026년 1차 공시) |
| 후기 데이터 | 활성 6,055건·1,892개원 (26.5% 기관 커버리지) |
| 결원 데이터 | 3,032개원·261/261 지역 (2026-08-06 수집) |
| 광고 | 배너 광고만 (전면 광고 없음) |
...
**구독·유료 순위·광고 확대를 정당화할 반복 사용이나 결제 증거는 아직 부족합니다.**
- 월 구독은 짧은 유치원 선택 주기와 맞지 않아 제외합니다.
- 기본 검색·비교는 무료와 중립성을 유지합니다.
- 실제 비교 행동을 바탕으로 한 `1회성 결정 완료 패스`만 제품 개발 전에 수동 선결제로 검증합니다.
- 결원 알림은 일일 수집 SLA와 사용자 열람 수요가 관측된 뒤 무료 대기목록부터 검증합니다.
...
|------|-----|------------|------------|
| 현재 | 10명 | 배너만 유지 | ~₩3,000 |
| 1단계 | 500명 | 광고 없는 신뢰 포지셔닝 + 후기 밀도 확보 | 직접 수익화 보류 |
| 2단계 | 2,000명 | 관심 유치원 저장/공유 루프 강화 | 직접 수익화 보류 |
| 3단계 | 5,000명 | 결원/모집 스냅샷 알림, 방문 체크리스트 패스 검증 | 소액 결제 테스트 |
| 4단계 | 10,000명 | 기관 공식 프로필/모집요강 보강 SaaS 검토 | B2B 실험 |
